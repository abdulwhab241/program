                    ...
                    <form method="post" action="{{ route('Promotion.store') }}">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputState" style="font-weight: bold;">{{trans('Students_trans.Grade')}}</label>
                            ...
                            <div class="form-group col">
                                <label for="Classroom_id" style="font-weight: bold;">{{trans('Students_trans.classrooms')}} : <span
